...
{
   "properties":{
      "clusterResourceId":"/subscriptions/8ecadfc9-d1a3-4ea4-b844-0d9f87e4d7c8/resourcegroups/$memberResourceGroup/providers/Microsoft.ContainerService/managedClusters/$memberCluster"
   }
}
END
)
