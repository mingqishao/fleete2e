...
az role assignment create --role "Azure Kubernetes Fleet Manager RBAC Cluster Admin" --assignee-object-id $objectID --subscription "3959ec86-5353-4b0c-b5d7-3877122861a0"